...
class TestUTF8SanitizationIntegration:
    ...
    def test_sanitize_utf8_string_integration(self) -> None:
        ...
        test_cases = [
            ...
            ("Product with \x00\x01\x02 control chars", "Product with \x00\x01\x02 control chars"),
        ...
        for input_val, expected in test_cases:
            ...
            if input_val is not None and isinstance(input_val, str) and "\\x" not in repr(input_val):
