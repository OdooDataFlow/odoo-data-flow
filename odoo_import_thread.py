...
if __name__ == '__main__':
    ...
    parser.add_argument('--groupby', dest='groupby', help='Group data per batch with the same value for the given column in order to avoid concurrent update error')
    ...
    import_threaded.import_data(args.config, args.model, file_csv=file_csv, context=context,
                                ...
                                ignore=ignore, groupby=groupby, check=args.check,
